...
class EncodecModel(nn.Module):
    ...
    def _get_model(target_bandwidths: tp.List[float],
        ...
        quantizer = qt.VectorQuantizer(vq_type='hexagon', dimension=512, codebook_dim=[7, 7, 7, 7, 7, 7], n_q=1, kmeans_iters=200, decay=0.99, kmeans_init=True)
        model = EncodecModel(
            encoder,
            decoder,
            quantizer,
